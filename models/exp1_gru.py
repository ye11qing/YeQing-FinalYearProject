...
class GRUCell(nn.Module):
    def __init__(self, input_dim: int, hidden_size: int):
        ...
        self.linear1 = GRULinear(self._hidden_size, self._hidden_size * 2, bias=1.0)
        self.linear2 = GRULinear(self._hidden_size, self._hidden_size)
...
class GRU(nn.Module):
    def __init__(self, input_dim: int, hidden_size: int, args, **kwargs):
        super(GRU, self).__init__()
        self._input_dim = input_dim  # num_nodes for prediction
        self._hidden_size = hidden_size
        self._pre_len = args.pre_len
        self.gru_cell = GRUCell(self._input_dim, self._hidden_size)
